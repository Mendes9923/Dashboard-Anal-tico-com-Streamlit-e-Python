...
# --- Criar o dataframe
df = pd.read_excel(
    io=r'C:\Users\Daniel Mendes\Downloads\Curso de Stramlit e Python\Datasets\system_extraction.xlsx',
    engine='openpyxl',
...
# -- Criar o sidebar
with st.sidebar:
    logo_teste = Image.open(r"C:\Users\Daniel Mendes\Downloads\Curso de Stramlit e Python\Mídia\logo vizion.png")
